    ...
    <div class="d-flex align-items-center mt-5">
        <div class="symbol symbol-100 mr-5">
            <div class="symbol-label"
                 style="background-image:url('{{ admin('avatar') }}')"></div>
            <i class="symbol-badge bg-success"></i>
        </div>
        <div class="d-flex flex-column">
            <a href="#"
               class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ admin('name') }}</a>
									...
									<span class="navi-icon mr-1">
										<span class="svg-icon svg-icon-lg svg-icon-primary">
											...
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g
                                                    fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"/><path
                                                        ...
                                                        fill="#000"/><circle fill="#000" opacity=".3" cx="19.5"
                                                                             cy="17.5" r="2.5"/></g></svg>
                                            <!--end::Svg Icon-->
										</span>
									</span>
                    ...
                    <div class="symbol-label">
                        <span class="svg-icon svg-icon-md svg-icon-success">
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g fill="none"
                                       ...
                                       fill="#000"/><circle fill="#000" opacity=".3" cx="18.5" cy="5.5"
                                                            r="2.5"/></g></svg>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                ...
                <div class="symbol symbol-40 bg-light mr-3">
                    <div class="symbol-label">
                        <span class="svg-icon svg-icon-md svg-icon-warning">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g fill="none"
                                                                                              fill-rule="evenodd"><path
                                        d="M0 0h24v24H0z"/><rect fill="#000" opacity=".3" x="12" y="4" width="3"
                                                                 height="13" rx="1.5"/><rect fill="#000" opacity=".3"
                                                                                             x="7" y="9" width="3"
                                                                                             height="8" rx="1.5"/><path
                                        d="M5 19h15a1 1 0 010 2H4a1 1 0 01-1-1V4a1 1 0 112 0v15z" fill="#000"
                                        fill-rule="nonzero"/><rect fill="#000" opacity=".3" x="17" y="11" width="3"
                                                                   height="6" rx="1.5"/></g></svg>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                </div>
